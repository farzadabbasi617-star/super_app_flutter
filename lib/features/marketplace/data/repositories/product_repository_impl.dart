  ...
  Future<List<Product>> getProducts({String? category, String? query}) async {
    ...
    final allProducts = [
      ...
      const Product(
        ...
        description:
            'هدفون ارگونومیک با نویز کنسلینگ فعال و بیس عمیق شگفت‌انگیز',
        price: 12000000.0,
        imageUrl:
      ...
      const Product(
        ...
        description:
            'سیستم آماده‌سازی اسپرسو و کاپوچینو با فوم شیر غلیظ اتوماتیک',
        price: 14000000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1517256064527-09c53b2d0c6b?w=150',
        category: 'Home',
      ),
      const Product(
        id: 'p_home_3',
        ...
        description:
            'جاروی هوشمند با قابلیت تی‌کشی چرخشی و نقشه‌برداری لیزری خانه',
        price: 19500000.0,
        imageUrl:
      ...
      const Product(
        ...
        description:
            'کتاب مرجع یادگیری پایتون از صفر تا صد همراه با پروژه‌های کاربردی',
        price: 250000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=150',
        category: 'Books',
      ),
      const Product(
        id: 'p_book_2',
        ...
        description:
            'رمان جاودانه صد سال تنهایی ترجمه بدون سانسور و با کیفیت نفیس',
        price: 120000.0,
        imageUrl:
      ...
      const Product(
        ...
        description:
            'کتاب موفقیت و روانشناسی اثر مرکب با جلد گالینگور نفیس هدیه',
        price: 95000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1495640388908-05fa85288e61?w=150',
        category: 'Books',
      ),
      ...
      const Product(
        ...
        description:
            'کامل‌ترین جعبه ابزار چمدانی شامل آچارهای کروم وانادیوم مستحکم رونیکس',
        price: 2400000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1581147036324-c17ac41dfa6c?w=150',
        category: 'Tools',
      ),
      const Product(
        id: 'p_tool_2',
        ...
        description:
            'دریل پیچ‌گوشتی شارژی با دو باتری لیتیومی قوی و کیف حمل ضربه‌گیر',
        price: 1950000.0,
        imageUrl:
      ...
      const Product(
        ...
        price: 1600000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1534224039826-c7a0eda0e6b3?w=150',
        category: 'Tools',
      ),
      ...
      const Product(
        ...
        description:
            'میکسر بتن پرقدرت ۲۵۰ لیتری صنعتی جهت پروژه‌های بتن‌ریزی ساختمان',
        price: 15000000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1581147036324-c17ac41dfa6c?w=150',
        category: 'Industrial',
      ...
      const Product(
        ...
        description:
            'تراکتور جفت دیفرانسیل سنگین کشاورزی آماده به کار با ادوات کامل',
        price: 250000000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=150',
      ...
      const Product(
        ...
        description:
            'ژنراتور برق سایلنت کانوپی‌دار مناسب کارگاه‌های عمرانی و صنعتی سنگین',
        price: 95000000.0,
        imageUrl:
            'https://images.unsplash.com/photo-1534224039826-c7a0eda0e6b3?w=150',
        category: 'Industrial',
