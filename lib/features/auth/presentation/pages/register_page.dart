...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _handleRegister() {
    ...
    if (_nameError == null && _emailError == null && _phoneError == null && _passwordError == null) {
      context.read<AuthBloc>().add(AuthRegisterRequested(email, password, name, phone, _selectedRole));
    }
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('Join Our Community', style: theme.textTheme.displayLarge?.copyWith(fontWeight: FontWeight.bold, fontSize: 32)),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ChoiceChip(
                        ...
                        onSelected: (_) => setState(() => _selectedRole = UserRole.professional),
                      ),
                    ),
                  ],
                ),
                ...
                AppTextField(
                  ...
                  onChanged: (val) => setState(() => _nameError = Validators.validateFullName(val)),
                ),
                ...
                AppTextField(
                  ...
                  onChanged: (val) => setState(() => _phoneError = Validators.validatePhone(val)),
                ),
                const SizedBox(height: 20),
                AppTextField(
                  label: 'Password',
                ...
                Center(
                  child: TextButton(
                    ...
                    child: Text('Already have an account? Login', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
